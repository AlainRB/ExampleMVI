...
import cu.xetid.examplemvi.R
import cu.xetid.examplemvi.data.model.TodoTask
import cu.xetid.examplemvi.ui.main.MainAdapter.MainAdapterRecyclerViewHolder

class MainAdapter(
    private var listTodoTasks: List<TodoTask>
) : RecyclerView.Adapter<MainAdapterRecyclerViewHolder>() {
    ...
    override fun onBindViewHolder(
        holder: MainAdapterRecyclerViewHolder,
        position: Int
    ) {
